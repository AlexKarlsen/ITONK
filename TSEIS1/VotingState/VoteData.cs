...
{
    // Defined as a Bond schema to assist with data versioning and serialization. // Using a structure and read only properties to make this an immutable entity. // This helps to ensure Reliable Collections are used properly.
    ...
    public struct VotingData
    {
        ...
        // DateTimeOffset is not a supported data type by Bond // This is the date and time of the last vote. [Bond.Id(30), Bond.Type(typeof(long))]
