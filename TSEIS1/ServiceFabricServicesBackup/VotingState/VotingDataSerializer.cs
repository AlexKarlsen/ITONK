...
namespace VotingState
{
    ...
    {
        private readonly static Serializer<CompactBinaryWriter<OutputBuffer>> Serializer; private readonly static Deserializer<CompactBinaryReader<InputBuffer>> Deserializer;
        ...
        public VotingData Read(BinaryReader binaryReader)
        {
            ...
            var reader = new CompactBinaryReader<InputBuffer>(input); return Deserializer.Deserialize<VotingData>(reader);
        }
        ...
        public void Write(VotingData value, BinaryWriter binaryWriter)
        {
            ...
            var writer = new CompactBinaryWriter<OutputBuffer>(output); Serializer.Serialize(value, writer);
