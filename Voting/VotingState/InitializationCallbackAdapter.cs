...
namespace VotingState
{
    ...
    public sealed class InitializationCallbackAdapter
    {
        ...
        {
            // This is marked obsolete, but is supported. This interface is likely // to change in the future.
            var serializer = new VotingDataSerializer(); this.StateManager.TryAddStateSerializer(serializer);
