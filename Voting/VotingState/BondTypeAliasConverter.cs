...
{
    /// <summary>
    /// This is needed to support DateTimeOffset use in Bond schemas. /// It converts the DateTimeOffset type to a long value and
    /// long values into DateTimeOffsets. See
    /// https://microsoft.github.io/bond/manual/bond_cs.html#converter /// </summary>
    public static class BondTypeAliasConverter
    {
        /// <summary>
        /// Converts a DateTimeOffset value to a long.
        /// </summary>
        /// <param name="value">DateTimeOffset value to convert.</param> /// <returns>Long integer value containing the number of ticks for
